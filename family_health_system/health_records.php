...
// 获取记录总数
$sql = "SELECT COUNT(*) as total FROM health_records hr
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-heart-pulse"></i> 健康记录</h2>
    <a href="add_health_record.php" class="btn btn-primary">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="health_records.php" class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6 d-flex align-items-end">
                ...
                <?php if ($member_id): ?>
                <a href="health_records.php" class="btn btn-secondary">清除筛选</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
...
<div class="card">
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <a href="edit_health_record.php?id=<?php echo $record['id']; ?>" class="btn btn-sm btn-outline-primary">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <a href="delete_health_record.php?id=<?php echo $record['id']; ?>" class="btn btn-sm btn-outline-danger delete-btn">
        ...
        <div class="text-center py-5">
            ...
            <h5 class="mt-3">暂无健康记录</h5>
            <p class="text-muted">点击"添加健康记录"按钮开始记录健康数据</p>
        </div>
        <?php endif; ?>
    </div>
</div>
